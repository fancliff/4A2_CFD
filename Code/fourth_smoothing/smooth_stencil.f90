...
!     Explicitly declare the required variables
      ...
      real, dimension(size(prop,1),size(prop,2)) :: prop_avg, sfac_loc
      integer :: ni, nj
...
!     j-directions.
      prop_avg(2:ni-1,2:nj-1) = ( prop(3:ni,2:nj-1) + prop(1:ni-2,2:nj-1) &
...
!     from the values at two nodes away from the boundary point.
      prop_avg(1,2:nj-1) = ( prop(1,1:nj-2) + prop(1,3:nj) &
      ...
      prop_avg(2:ni-1,nj) = ( prop(3:ni,nj) + prop(1:ni-2,nj) &
...
!     of the surrounding values. 
      sfac_loc = av%sfac/prop_ref * abs(prop - prop_avg)
      write(6,*)
      write(6,*)
      !write(6,*) sfac_loc
      write(6,*)
      write(6,*)
      prop = (1.0 - sfac_loc) * prop + sfac_loc * prop_avg
